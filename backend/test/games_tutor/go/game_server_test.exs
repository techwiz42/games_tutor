defmodule GamesTutor.Go.GameServerTest do
  ...
  # See GamesTutor.Go.EngineTest for line-buffering / concurrent-query /
  # process-death-guarantee coverage -- that logic moved to
  # GamesTutor.Go.Engine (the single shared KataGo process every GameServer
  # now queries), not owned by GameServer itself anymore.
